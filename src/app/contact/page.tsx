  ...
  return (
    <div className="group relative z-0 transition-all focus-within:z-10">
      <input
        ...
        {...props}
        placeholder=" "
        className="peer block w-full border border-neutral-300 bg-transparent px-6 pb-4 pt-12 text-base/6 text-sky-800 ring-4 ring-transparent transition focus:border-sky-800 focus:outline-none focus:ring-sky-800/5 group-first:rounded-t-2xl group-last:rounded-b-2xl"
      />
      <label
        htmlFor={id}
  ...
  return (
    <FadeIn>
      ...
      <p className="mt-6 text-base text-neutral-600">
        Even more cities coming soon! We can’t wait to hear from you.
      </p>
      ...
      <Border className="mt-16 pt-16">
        ...
        <dl className="mt-6 grid grid-cols-1 gap-8 text-sm sm:grid-cols-2">
          {[['More information at', 'glamourfelin@gmail.com']].map(
            ([label, email]) => (
              <div key={email}>
                ...
                <dd>
                  <Link
                    href={`mailto:${email}`}
                    className="text-neutral-600 hover:text-sky-800"
                  >
                    {email}
                  </Link>
                </dd>
...
export const metadata: Metadata = {
  title: 'Contact Us for a Free Quote | Glamour Félin',
...
export default function Contact() {
  return (
    <>
      <PageIntro eyebrow="Contact us" title="Your cat deserves to be glamorous">
